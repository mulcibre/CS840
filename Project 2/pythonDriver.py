...
indentLevel = 2
firstLoopLine = 25
sourceFilename = 'pythonMatMult.py'
outputFilename = 'outfiles/pythonoutfile.txt'
...
forLoops =  ['for i in range(0,matSize):\n',
...
def executeTestFile():
    ...
    with open(outputFilename, "a") as outfile:
        ...
        outfile.seek( 0, 2 ) 
        call(["python", sourceFilename], stderr=outfile, stdout=outfile)
