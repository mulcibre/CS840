#   Samuel Gluss
#   3/6/2016
#   Driver program for ruby Matrix Multiplication
...
indentLevel = 2
firstLoopLine = 40
sourceFilename = 'JSmatmult.js'
outputFilename = 'outfiles/JSoutfile.txt'
...
forLoops =  ['for(var i = 0; i<rowCount; i++) {\n',
...
def executeTestFile():
    #   compile step, if needed (keep this for the C++/Java code)
    #call(["msbuild", "D:\Sam\Documents\Visual Studio 2015\Projects\CS840\Project1 part 3 matrix multiplication\Project1 part 3 matrix multiplication.sln"])

    #   execute source code, writing results to outfile
    with open(outputFilename, "a") as outfile:
        #   The below line of code seeks to the end of the outfile
        outfile.seek( 0, 2 ) 
        call(["phantomjs.exe", sourceFilename], stderr=outfile, stdout=outfile)
